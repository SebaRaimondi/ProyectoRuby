...
class EvaluationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evaluation" do
    assert_difference('Evaluation.count') do
      post evaluations_url, params: { evaluation: { course_id: @evaluation.course_id, date: @evaluation.date, title: @evaluation.title } }
    end
  ...
  test "should update evaluation" do
    patch evaluation_url(@evaluation), params: { evaluation: { course_id: @evaluation.course_id, date: @evaluation.date, title: @evaluation.title } }
